...
st.markdown(""" The Building Data Genome Directory – An open, comprehensive data sharing platform for building performance research. https://iopscience.iop.org/article/10.1088/1742-6596/2600/3/032003""")
st.markdown(""" """)
